...
export function Msearch ({ setMainCat,setShowSearch}: {  setMainCat: React.Dispatch<React.SetStateAction<mainCatType | null>>;setShowSearch:React.Dispatch<React.SetStateAction<boolean>> }) {
