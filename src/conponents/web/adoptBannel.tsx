...
export function Adoptbannel ({CatId}: {CatId: number}) {
  ...
  return(
    <div className={style.bannel} aria-busy={loading} aria-live="polite">
      ...
      <div className={style.imgcontains}>
        <div className={`iconfont icon-cha ${style.out}`}></div>
...
></span>
    ...
    <div className={style.btncontains}>
      <span className={style.adoptbtn}>我想领养</span>
      <span className={style.shareimg}>分享海报</span>
    </div>
      </div>
    </div>
  )
